...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon.addPixmap(QtGui.QPixmap("piggy-bank.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1.addPixmap(QtGui.QPixmap("donation.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
