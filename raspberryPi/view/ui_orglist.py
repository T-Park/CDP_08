...
# Form implementation generated from reading ui file 'orglist.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.listWidget.setGeometry(QtCore.QRect(50, 100, 701, 281))
        ...
        self.selectButton.setGeometry(QtCore.QRect(530, 400, 181, 61))
        font = QtGui.QFont()
        font.setFamily("서울남산체 M")
        font.setPointSize(14)
        ...
        self.nextButton.setGeometry(QtCore.QRect(310, 400, 181, 61))
        font = QtGui.QFont()
        font.setFamily("서울남산체 M")
        font.setPointSize(14)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.selectButton.setText(_translate("Dialog", "다음페이지 →"))
        self.nextButton.setText(_translate("Dialog", "선택"))
