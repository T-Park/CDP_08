...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(800, 480)
        self.savedAmountButton = QtWidgets.QTextBrowser(Form)
        self.savedAmountButton.setGeometry(QtCore.QRect(310, 160, 261, 70))
        self.savedAmountButton.setObjectName("savedAmountButton")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "적립하신 금액은"))
