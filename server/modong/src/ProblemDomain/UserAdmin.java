...
public class UserAdmin {
	private static UserAdmin unicqueUserAdmin; //singleton 사용
	...
	private final static int default_userDonationPoint = 0; //user 생성시 default donation point
...
/* 구 그룹 바코드 메소드
		...
		//각 String마다 index 찾기, sumpoint 계산.
		for(int i=0; i < ids.length; i++)
		{
			int currentIndex = searchUser_asId(ids[i]);
			if(currentIndex == -1)
