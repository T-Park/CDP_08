...
public class StoreAdmin {
	...
	class Store {
		...
		public Store(int pid, String name, char type, String city, String district, String detail, String tel) {
			store_id = pid;
			store_name = name;
			store_type = type;
			store_city = city;
		...
		public String toString() {
			return store_id + " : " + store_name + " " + store_type + " " + store_city + " " + store_district + " "
					+ store_detailAddr + " " + store_tel;
		}
