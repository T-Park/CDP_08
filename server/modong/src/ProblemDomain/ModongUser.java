...
/*
 * public int addPoint_fromStore(int i)//적립하기-가맹점 { user_point = user_point + i;
 * return user_point; } public int addPoint_fromCoinCollector(int i)//적립하기-동전모음이
 * { user_point = user_point + i; return user_point; }
 * 
 * 
 * 
 * 
 * class UseDetail { String where; Date when; int point;
 * 
 * UseDetail(String where, Date when, int point) { this.where = where; this.when
 ...
 * 
 * } class DonationList { String where; Date when; int point;
 * 
 * DonationList(String where, Date when, int point) { this.where = where;
 * this.when = when; this.point = point; }
 * 
 * public String getWhere() { return where; }
 * 
 * public Date getWhen() { return when; }
