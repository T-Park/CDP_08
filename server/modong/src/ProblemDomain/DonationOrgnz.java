...
public class DonationOrgnz {
	...
	/*
	 * public int addPoint(int i) { donation_point = i + donation_point; //db 처리
	 * return donation_point; } public int usePoint(int did, int point) {
	 * if(donation_point < point)//point가 부족한데 시도 { //경고 System.out.println(
	 * "point가 부족합니다."); return donation_point; }
	 * 
	 * //db PE donation_point = donation_point - point; return donation_point;
	 * //current point }
	 */

	public String toString() {
		return donation_id + " : " + donation_name + " " + donation_point + " " + donation_tel + " " + donation_type
				+ "";
	}
