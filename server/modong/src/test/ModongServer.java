...
*/		/* teset */
		...
		//
		// sendToMyClient(client,
		// "#" + md.getUser_id() + "%" + md.getUser_pw() + "%" +
		//// md.getUser_name() +
		//// "%" + md.getUser_job()
		// + "%" + md.getUser_age() + "%" + md.getUser_tel() + "%" + groupFlag +
		//// "%"
		//// + groupName);
		// } else {
		...
		// sendToMyClient(client, "asdf123123");
		//
		/// *
